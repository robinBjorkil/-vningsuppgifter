...
//Skriv om funktionen ovan så att den istället för att skriva ut namnet returnerar en string
//med hela namnet. Anropa funktionen och skriv ut returvärdet.
...
//Skriv en funktion som tar in en sträng och returnerar en sträng med ett bindestreck
//mellan varje tecken. T.ex om man skickar in “Fredrik” , så returnerar den “F-r-e-d-r-i-k”
...
//static string PrintName(string text)
//{
...
//Console.WriteLine("Skriv några länder.");
//Console.WriteLine("Skriv en symbol av ett eller flera tecken");
//static string MyJoin(string symbol, string country1, string country2, string country3)
//{
//    string[] countries = new string[] { country1, country2, country3 };
...
//string[] countries = new string[] { "Sverige", "Norge", "Finland" };
...
//8. Siffror till text
//Skriv en funktion som tar ett heltal in, och returnerar en string[] där varje element
//innehåller ordet för varje siffra i talet.
...
//9.Heltal till text
//Skriv en funktion som tar en ushort som parameter, och returnerar en sträng med numret
//utskrivet i ord.
...
//Skapa funktionen int[] IndexesOf(string text, char c) som söker igenom strängen text och
//returnerar en int[] med index till alla förekomster av c i text.
...
//När man anropar funktionen ska den skriva ut en rektangel där de yttre
//tecknen består av ‘#’ och de inre av ‘-’.
...
//Tips: Använd Console.SetCursorPosition(); för att flytta Cursorn,
//d.v.s var nästa tecken ska skrivas. Om du vill kan du även dölja cursorn genom att
//sätta Console.CursorVisible = false;

//Tips: Använd Thread.Sleep(n); för att lägga in en fördröjning på n millisekunder
//innan nästa rektangel ritas ut.
...
//14.Masken
//Skriv om DrawBox() så den istället returnerar en 2D-array av char med tecknen som
...
//Extra utmaning 2: I det klassiska spelet "masken" (snake)
//förflyttar sig en mask i jämna tidsintervall i den riktning spelaren senast angav med piltangenterna.
